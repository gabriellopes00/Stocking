...
class Validation{  
  ...
  suppliesValidation: Yup.ObjectSchema<Yup.Shape<object | undefined, { supplyDate: string; quantity: number; price: number; paymentMethod: string; suppliesDescription: string | undefined; providerId: number; productId: number; }>, object>;
  salesValidation: Yup.ObjectSchema<Yup.Shape<object | undefined, { quantity: number; price: number; paymentMethod: string; description: string | undefined; clientId: number; productId: number; }>, object>;
  ...
  constructor(){
    ...
    this.suppliesValidation = Yup.object().shape({
      ...
      suppliesDescription: Yup.string().max(500).optional(),
